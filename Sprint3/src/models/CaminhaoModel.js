...
function buscarCaminhoes(idEmpresa) {
    ...
    Caminhao.idCaminhao as 'idCaminhão' , 
    DadosMedidos.dataDados as "Data dos dados",
    DadosMedidos.temperatura as "Temperatura",
    Produto.nomeProduto as "Nome do produto"
    from Caminhao
    join Produto
